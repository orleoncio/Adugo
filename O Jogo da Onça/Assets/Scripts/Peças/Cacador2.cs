...
public class Cacador2 : MonoBehaviour
{
    public static Cacador2 instance;
    ...
    private void OnMouseDown()
    {
        if (!GameController.instance.selectedPiece && GameController.instance.rodada % 2 == 1)
        {
            ...
            GameController.instance.casaSelecionada = "Caçador2";
        }
    }
    ...
    {
        PiecesPosition.instance.pecaComida[2] = true;
