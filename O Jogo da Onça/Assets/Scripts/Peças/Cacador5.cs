...
public class Cacador5 : MonoBehaviour
{
    public static Cacador5 instance;
    ...
    private void OnMouseDown()
    {
        if (!GameController.instance.selectedPiece && GameController.instance.rodada % 2 == 1)
        {
            ...
            GameController.instance.casaSelecionada = "Caçador5";
        }
    }
    ...
    {
        PiecesPosition.instance.pecaComida[5] = true;
