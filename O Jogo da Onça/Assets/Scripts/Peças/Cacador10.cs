...
public class Cacador10 : MonoBehaviour
{
    public static Cacador10 instance;
    ...
    private void OnMouseDown()
    {
        if (!GameController.instance.selectedPiece && GameController.instance.rodada % 2 == 1)
        {
            ...
            GameController.instance.casaSelecionada = "Caçador10";
        }
    }
    ...
    {
        PiecesPosition.instance.pecaComida[10] = true;
