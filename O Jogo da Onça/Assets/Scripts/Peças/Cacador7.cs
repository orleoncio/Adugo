...
public class Cacador7 : MonoBehaviour
{
    public static Cacador7 instance;
    ...
    private void OnMouseDown()
    {
        if (!GameController.instance.selectedPiece && GameController.instance.rodada % 2 == 1)
        {
            ...
            GameController.instance.casaSelecionada = "Caçador7";
        }
    }
    ...
    {
        PiecesPosition.instance.pecaComida[7] = true;
