...
public class Cacador9 : MonoBehaviour
{
    public static Cacador9 instance;
    ...
    private void OnMouseDown()
    {
        if (!GameController.instance.selectedPiece && GameController.instance.rodada % 2 == 1)
        {
            ...
            GameController.instance.casaSelecionada = "Caçador9";
        }
    }
    ...
    {
        PiecesPosition.instance.pecaComida[9] = true;
