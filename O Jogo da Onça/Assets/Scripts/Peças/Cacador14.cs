...
public class Cacador14 : MonoBehaviour
{
    public static Cacador14 instance;
    ...
    private void OnMouseDown()
    {
        if (!GameController.instance.selectedPiece && GameController.instance.rodada % 2 == 1)
        {
            ...
            GameController.instance.casaSelecionada = "Caçador14";
        }
    }
    ...
    {
        PiecesPosition.instance.pecaComida[14] = true;
