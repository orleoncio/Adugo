...
public class Cacador6 : MonoBehaviour
{
    public static Cacador6 instance;
    ...
    private void OnMouseDown()
    {
        if (!GameController.instance.selectedPiece && GameController.instance.rodada % 2 == 1)
        {
            ...
            GameController.instance.casaSelecionada = "Caçador6";
        }
    }
    ...
    {
        PiecesPosition.instance.pecaComida[6] = true;
