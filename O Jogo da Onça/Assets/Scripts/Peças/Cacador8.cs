...
public class Cacador8 : MonoBehaviour
{
    public static Cacador8 instance;
    ...
    private void OnMouseDown()
    {
        if (!GameController.instance.selectedPiece && GameController.instance.rodada % 2 == 1)
        {
            ...
            GameController.instance.casaSelecionada = "Caçador8";
        }
    }
    ...
    {
        PiecesPosition.instance.pecaComida[8] = true;
