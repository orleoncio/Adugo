...
public class Cacador3 : MonoBehaviour
{
    public static Cacador3 instance;
    ...
    private void OnMouseDown()
    {
        if (!GameController.instance.selectedPiece && GameController.instance.rodada % 2 == 1)
        {
            ...
            GameController.instance.casaSelecionada = "Caçador3";
        }
    }
    ...
    {
        PiecesPosition.instance.pecaComida[3] = true;
