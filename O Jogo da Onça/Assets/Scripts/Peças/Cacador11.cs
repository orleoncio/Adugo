...
public class Cacador11 : MonoBehaviour
{
    public static Cacador11 instance;
    ...
    private void OnMouseDown()
    {
        if (!GameController.instance.selectedPiece && GameController.instance.rodada % 2 == 1)
        {
            ...
            GameController.instance.casaSelecionada = "Caçador11";
        }
    }
    ...
    {
        PiecesPosition.instance.pecaComida[11] = true;
