...
public class Cacador4 : MonoBehaviour
{
    public static Cacador4 instance;
    ...
    private void OnMouseDown()
    {
        if (!GameController.instance.selectedPiece && GameController.instance.rodada % 2 == 1)
        {
            ...
            GameController.instance.casaSelecionada = "Caçador4";
        }
    }
    ...
    {
        PiecesPosition.instance.pecaComida[4] = true;
