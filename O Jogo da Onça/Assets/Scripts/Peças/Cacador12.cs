...
public class Cacador12 : MonoBehaviour
{
    public static Cacador12 instance;
    ...
    private void OnMouseDown()
    {
        if (!GameController.instance.selectedPiece && GameController.instance.rodada % 2 == 1)
        {
            ...
            GameController.instance.casaSelecionada = "Caçador12";
        }
    }
    ...
    {
        PiecesPosition.instance.pecaComida[12] = true;
